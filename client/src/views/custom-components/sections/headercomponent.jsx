                ...
                <Container>
                    <Row className="justify-content-center">
                        <Col md="7" className="text-center">
                            <h1 className="title font-bold">Home Page</h1>
       </Col>
                    </Row>
                </Container>
            </div>
                    ...
                    <Navbar className="navbar-expand-lg h1-nav">
                        ...
                        <Collapse isOpen={isOpen} navbar id="header1">
                            <Nav navbar className="ms-auto mt-2 mt-lg-0">
                                <NavItem className="active"><NavLink href="#">Profile</NavLink></NavItem>
                                <NavItem><NavLink href="#">Blog</NavLink></NavItem>
                                <NavItem><NavLink href="#">Chatbot</NavLink></NavItem>
                                <UncontrolledDropdown nav inNavbar>
                                    <DropdownToggle nav>
                                        Psychiatrist services <i className="fa fa-angle-down m-l-5"></i>
                                    </DropdownToggle>
                                ...
                                <NavItem><a className="btn btn-outline-success" href="#">Logout</a></NavItem>
                            </Nav>
                        </Collapse>
                    </Navbar>
                </Container>
